...
const timeoutHandlerMsg = "handler timeout exceeded"
...
func NewHandler(h http.HandlerFunc, ht time.Duration, l *l.Logger) *Handler {
	return &Handler{
		handler: http.TimeoutHandler(h, ht, timeoutHandlerMsg),
		logger:  l,
	}
}
